clear @s command_block{ucit:{id:"everlasting_cookie"}}
loot give @s loot boomber:everlasting_food/item/cookie/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/cookie/0
