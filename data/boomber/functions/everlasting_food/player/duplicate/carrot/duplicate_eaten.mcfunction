clear @s command_block{ucit:{id:"everlasting_carrot"}}
loot give @s loot boomber:everlasting_food/item/carrot/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/carrot/0
