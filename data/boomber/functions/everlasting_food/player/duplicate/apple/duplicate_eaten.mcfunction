clear @s command_block{ucit:{id:"everlasting_apple"}}
loot give @s loot boomber:everlasting_food/item/apple/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/apple/0
