clear @s cooked_porkchop{ucit:{id:"everlasting_cooked_porkchop"}}
loot give @s loot boomber:everlasting_food/item/cooked_porkchop/cooked_porkchop
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/cooked_porkchop/cooked_porkchop
