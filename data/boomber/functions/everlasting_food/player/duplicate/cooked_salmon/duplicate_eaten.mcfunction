clear @s command_block{ucit:{id:"everlasting_cooked_salmon"}}
loot give @s loot boomber:everlasting_food/item/cooked_salmon/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/cooked_salmon/0
