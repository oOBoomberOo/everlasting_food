clear @s command_block{ucit:{id:"everlasting_cooked_chicken"}}
loot give @s loot boomber:everlasting_food/item/cooked_chicken/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/cooked_chicken/0
