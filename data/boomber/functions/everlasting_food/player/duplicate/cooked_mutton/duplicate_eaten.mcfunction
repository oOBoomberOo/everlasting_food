clear @s command_block{ucit:{id:"everlasting_cooked_mutton"}}
loot give @s loot boomber:everlasting_food/item/cooked_mutton/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/cooked_mutton/0
