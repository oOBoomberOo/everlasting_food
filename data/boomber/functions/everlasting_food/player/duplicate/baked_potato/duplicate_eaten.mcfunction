clear @s command_block{ucit:{id:"everlasting_baked_potato"}}
loot give @s loot boomber:everlasting_food/item/baked_potato/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/baked_potato/0
