clear @s command_block{ucit:{id:"everlasting_melon_slice"}}
loot give @s loot boomber:everlasting_food/item/melon_slice/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/melon_slice/0
