clear @s command_block{ucit:{id:"everlasting_cooked_beef"}}
loot give @s loot boomber:everlasting_food/item/cooked_beef/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/cooked_beef/0
