clear @s mushroom_stew{ucit:{id:"everlasting_mushroom_stew"}}
loot give @s loot boomber:everlasting_food/item/mushroom_stew/mushroom_stew
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/mushroom_stew/mushroom_stew
