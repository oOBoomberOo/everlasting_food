clear @s command_block{ucit:{id:"everlasting_pumpkin_pie"}}
loot give @s loot boomber:everlasting_food/item/pumpkin_pie/0
loot spawn ~ ~ ~ loot boomber:everlasting_food/item/pumpkin_pie/0
